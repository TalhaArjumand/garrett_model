...
class KeyLevelIntegrationTests(unittest.TestCase):
    ...
    def test_detect_external_to_internal_type_b_candidates_supports_preexisting_bullish_erl(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
        ...
        candidates = detect_external_to_internal_type_b_candidates(candles)
    ...
    def test_detect_external_to_internal_type_b_candidates_allows_erl_confirmed_on_c1_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
            ...
            self.make_candle(timestamp_hour=12, open=100.5, high=116, low=99, close=111),
        ]
    ...
    def test_detect_external_to_internal_type_b_candidates_supports_preexisting_bearish_erl(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=100, high=105, low=95, close=100),
            ...
            self.make_candle(timestamp_hour=8, open=113, high=115, low=100, close=102),
            self.make_candle(timestamp_hour=12, open=102, high=119, low=101, close=118),
            self.make_candle(timestamp_hour=16, open=120.5, high=121, low=105, close=110),
        ]
        ...
        self.assertEqual(candidates[0].erl_side, "buy_side")
        self.assertEqual(candidates[0].key_level_touch, "c2")
        self.assertEqual(count_external_to_internal_type_b_sequences(candles), (0, 1))

    def test_detect_external_to_internal_type_b_candidates_rejects_taken_erl_before_sequence(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
            ...
            self.make_candle(timestamp_hour=8, open=101, high=115, low=101, close=114),
            self.make_candle(timestamp_hour=12, open=114, high=116, low=99, close=104),
            self.make_candle(timestamp_hour=16, open=104, high=118, low=98, close=105),
            self.make_candle(timestamp_hour=20, open=105, high=117, low=97, close=104),
            self.make_candle(timestamp_hour=24, open=98.5, high=116, low=96, close=111),
        ]
    ...
    def test_detect_external_to_internal_type_c_candidates_supports_preexisting_bullish_erl(
        ...
        candles = [
            ...
            self.make_candle(timestamp_hour=8, open=101, high=115, low=101, close=114),
            self.make_candle(timestamp_hour=12, open=114, high=118, low=101, close=105),
            self.make_candle(timestamp_hour=16, open=105, high=106, low=99, close=100),
            self.make_candle(timestamp_hour=20, open=101, high=120, low=100.5, close=119),
        ]

        candidates = detect_external_to_internal_type_c_candidates(candles)
        ...
        self.assertEqual(candidates[0].key_level_touch, "c2")
        self.assertLess(candidates[0].erl_confirmed_at, candidates[0].sequence_c1_timestamp)
        self.assertEqual(count_external_to_internal_type_c_sequences(candles), (1, 0))

    def test_detect_external_to_internal_type_c_candidates_allows_erl_confirmed_on_c1_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
            self.make_candle(timestamp_hour=4, open=108, high=109, low=100, close=101),
            self.make_candle(timestamp_hour=8, open=101, high=115, low=101, close=104),
            self.make_candle(timestamp_hour=12, open=104, high=105, low=99, close=100),
            self.make_candle(timestamp_hour=16, open=101, high=120, low=100.5, close=119),
        ]
    ...
    def test_detect_external_to_internal_type_c_candidates_ignores_fresh_erl_confirmed_on_c2_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
            self.make_candle(timestamp_hour=4, open=108, high=109, low=100, close=101),
            self.make_candle(timestamp_hour=8, open=101, high=115, low=99, close=100),
            self.make_candle(timestamp_hour=12, open=101, high=120, low=100.5, close=119),
        ]

        self.assertTrue(is_bullish_c3_closure(candles[1], candles[2], candles[3]))
        self.assertEqual(detect_external_to_internal_type_c_candidates(candles), [])
        self.assertEqual(count_external_to_internal_type_c_sequences(candles), (0, 0))

    def test_detect_external_to_internal_type_c_candidates_rejects_type_b_overlap(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
            ...
            self.make_candle(timestamp_hour=12, open=114, high=118, low=101, close=105),
            self.make_candle(timestamp_hour=16, open=100.5, high=116, low=99, close=111),
            self.make_candle(timestamp_hour=20, open=111, high=120, low=100.5, close=119),
        ]
    ...
    def test_detect_external_to_internal_type_c_candidates_rejects_type_b_additive_extension_overlap(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
            ...
            self.make_candle(timestamp_hour=8, open=101, high=115, low=101, close=114),
            self.make_candle(timestamp_hour=12, open=114, high=118, low=101, close=105),
            self.make_candle(timestamp_hour=16, open=100.5, high=118, low=99, close=117),
            self.make_candle(timestamp_hour=20, open=117, high=124, low=116, close=123),
        ]
    ...
    def test_detect_external_to_internal_type_d_candidates_returns_bullish_pairings_and_dedupes_counts(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
            ...
            self.make_candle(timestamp_hour=8, open=101, high=115, low=101, close=114),
            self.make_candle(timestamp_hour=12, open=114, high=118, low=101, close=105),
            self.make_candle(timestamp_hour=16, open=105, high=110, low=99, close=100.5),
            self.make_candle(timestamp_hour=20, open=101, high=109, low=100, close=104),
        ]

        candidates = detect_external_to_internal_type_d_candidates(candles)

        self.assertEqual(len(candidates), 1)
        self.assertEqual(candidates[0].direction, "bullish")
        self.assertEqual(candidates[0].erl_kind, "old_low")
        self.assertEqual(candidates[0].key_level_touch, "c2")
        self.assertEqual(count_external_to_internal_type_d_sequences(candles), (1, 0))
        self.assertEqual(count_external_to_internal_type_c_sequences(candles), (0, 0))

    def test_detect_external_to_internal_type_d_candidates_allows_erl_confirmed_on_c1_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
            self.make_candle(timestamp_hour=4, open=108, high=109, low=100, close=101),
            self.make_candle(timestamp_hour=8, open=101, high=115, low=101, close=114),
            self.make_candle(timestamp_hour=12, open=114, high=118, low=99, close=100.5),
            self.make_candle(timestamp_hour=16, open=101, high=109, low=100, close=104),
        ]
    ...
    def test_detect_external_to_internal_type_d_candidates_ignores_fresh_erl_confirmed_on_c2_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
            self.make_candle(timestamp_hour=4, open=108, high=109, low=101, close=102),
            self.make_candle(timestamp_hour=8, open=103, high=114, low=100, close=100.5),
            self.make_candle(timestamp_hour=12, open=101, high=110, low=101, close=102.5),
        ]

        self.assertTrue(is_bullish_type_d(candles[1], candles[2], candles[3]))
        self.assertEqual(detect_external_to_internal_type_d_candidates(candles), [])
        self.assertEqual(count_external_to_internal_type_d_sequences(candles), (0, 0))

    def test_detect_external_to_internal_type_d_candidates_rejects_overlap_with_strict_type_c(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=110, high=112, low=105, close=108),
    ...
    def test_detect_internal_to_external_type_d_candidates_returns_bullish_pairings_and_dedupes_counts(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=96, high=100, low=95, close=99),
            ...
            self.make_candle(timestamp_hour=8, open=104, high=110, low=102, close=109),
            self.make_candle(timestamp_hour=12, open=106, high=107, low=101, close=103),
            self.make_candle(timestamp_hour=16, open=103, high=112, low=99, close=108),
            self.make_candle(timestamp_hour=20, open=108, high=110, low=100, close=104),
        ]

        candidates = detect_internal_to_external_type_d_candidates(candles)

        self.assertEqual(len(candidates), 1)
        self.assertEqual(candidates[0].direction, "bullish")
        self.assertEqual(candidates[0].key_level_touch, "both")
        self.assertEqual(count_internal_to_external_type_d_sequences(candles), (1, 0))
        self.assertEqual(count_internal_to_external_type_c_sequences(candles), (0, 0))

    def test_detect_internal_to_external_type_d_candidates_allows_gap_confirmed_on_c1_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=120, high=125, low=115, close=118),
            self.make_candle(timestamp_hour=4, open=118, high=119, low=105, close=106),
            self.make_candle(timestamp_hour=8, open=106, high=107, low=101, close=103),
            self.make_candle(timestamp_hour=12, open=103, high=116, low=100, close=114),
            self.make_candle(timestamp_hour=16, open=114, high=115, low=108, close=109),
        ]
        ...
        self.assertEqual(candidates[0].key_level_touch, "c2")
        self.assertEqual(candidates[0].irl_confirmed_at, candles[2].timestamp)
        self.assertEqual(count_internal_to_external_type_d_sequences(candles), (0, 1))

    def test_detect_internal_to_external_type_d_candidates_ignores_fresh_gap_confirmed_on_c2_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=80, high=95, low=79, close=90),
            self.make_candle(timestamp_hour=4, open=106, high=107, low=101, close=103),
            self.make_candle(timestamp_hour=8, open=103, high=112, low=99, close=108),
            self.make_candle(timestamp_hour=12, open=108, high=110, low=100, close=104),
        ]

        self.assertEqual(detect_internal_to_external_type_d_candidates(candles), [])
        self.assertEqual(count_internal_to_external_type_d_sequences(candles), (0, 0))

    def test_detect_internal_to_external_type_d_candidates_rejects_close_through_invalidation(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=96, high=100, low=95, close=99),
            ...
            self.make_candle(timestamp_hour=12, open=106, high=107, low=101, close=103),
            self.make_candle(timestamp_hour=16, open=103, high=112, low=99, close=108),
            self.make_candle(timestamp_hour=20, open=108, high=110, low=99.2, close=99.3),
        ]

        self.assertEqual(detect_internal_to_external_type_d_candidates(candles), [])
        self.assertEqual(count_internal_to_external_type_d_sequences(candles), (0, 0))

    def test_detect_internal_to_external_type_d_candidates_rejects_overlap_with_strict_type_c(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=96, high=100, low=95, close=99),
    ...
    def test_detect_internal_to_external_type_b_additive_extension_candidates_returns_bullish_pairings_and_dedupes_counts(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=96, high=100, low=95, close=99),
    ...
    def test_detect_internal_to_external_type_b_additive_extension_candidates_allows_gap_confirmed_on_c1_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=96, high=100, low=95, close=99),
    ...
    def test_detect_internal_to_external_type_b_additive_extension_candidates_ignores_fresh_gap_confirmed_on_c2_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=100, high=105, low=95, close=98),
        ...
        self.assertTrue(is_bullish_type_b_additive_extension(candles[2], candles[3], candles[4]))
        self.assertEqual(detect_internal_to_external_type_b_additive_extension_candidates(candles), [])
        self.assertEqual(
            count_internal_to_external_type_b_additive_extension_sequences(candles),
            (0, 0),
        )

    def test_detect_internal_to_external_type_b_additive_extension_candidates_rejects_close_through_invalidation(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=100, high=110, low=95, close=108),
            ...
            self.make_candle(timestamp_hour=16, open=112, high=113, low=100, close=103),
            self.make_candle(timestamp_hour=20, open=103, high=105, low=90, close=92),
        ]

        self.assertTrue(is_bearish_type_b_additive_extension(candles[3], candles[4], candles[5]))
        self.assertEqual(detect_internal_to_external_type_b_additive_extension_candidates(candles), [])
        self.assertEqual(
            count_internal_to_external_type_b_additive_extension_sequences(candles),
            (0, 0),
    ...
    def test_detect_internal_to_external_type_b_additive_extension_c3_quality_candidates_returns_bullish_pairings_and_dedupes_counts(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=96, high=100, low=95, close=99),
        ...
        self.assertEqual(
            count_internal_to_external_type_b_additive_extension_c3_quality_sequences(candles),
            (1, 0),
        )

    def test_detect_internal_to_external_type_b_additive_extension_c3_quality_candidates_allows_gap_confirmed_on_c1_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=96, high=100, low=95, close=99),
    ...
    def test_detect_internal_to_external_type_b_additive_extension_c3_quality_candidates_ignores_fresh_gap_confirmed_on_c2_close(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=100, high=105, low=95, close=98),
        ...
        self.assertEqual(
            detect_internal_to_external_type_b_additive_extension_c3_quality_candidates(candles),
            [],
        )
        self.assertEqual(
            count_internal_to_external_type_b_additive_extension_c3_quality_sequences(candles),
    ...
    def test_detect_internal_to_external_type_b_additive_extension_c3_quality_candidates_rejects_large_c3_same_side_wick(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=96, high=100, low=95, close=99),
        ...
        base_candidates = detect_internal_to_external_type_b_additive_extension_candidates(candles)
        strict_candidates = (
            detect_internal_to_external_type_b_additive_extension_c3_quality_candidates(candles)
        )
    ...
    def test_detect_internal_to_external_type_b_additive_extension_c3_quality_candidates_rejects_close_through_invalidation(
        self,
    ) -> None:
        candles = [
            self.make_candle(timestamp_hour=0, open=120, high=122, low=110, close=111),
