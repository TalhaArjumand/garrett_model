...
class RealOhlcVerificationTests(unittest.TestCase):
    ...
    def test_real_xauusd_4h_sample_loads_and_reports(self) -> None:
        ...
        self.assertGreaterEqual(report.bullish_internal_to_external_type_a_count, 0)
        self.assertGreaterEqual(report.bearish_internal_to_external_type_a_count, 0)
        self.assertGreaterEqual(
            report.bullish_internal_to_external_type_a_expansion_quality_count,
            0,
        )
        self.assertGreaterEqual(
        ...
        self.assertGreaterEqual(
            report.bullish_external_to_internal_type_b_additive_extension_count,
            0,
        )
        self.assertGreaterEqual(
            report.bearish_external_to_internal_type_b_additive_extension_count,
            0,
        )
        self.assertGreaterEqual(
            report.bullish_external_to_internal_type_b_additive_extension_c3_quality_count,
            0,
        )
        self.assertGreaterEqual(
            report.bearish_external_to_internal_type_b_additive_extension_c3_quality_count,
            0,
        )
        self.assertGreaterEqual(report.bullish_external_to_internal_type_c_count, 0)
        self.assertGreaterEqual(report.bearish_external_to_internal_type_c_count, 0)
        self.assertGreaterEqual(report.bullish_external_to_internal_type_d_count, 0)
        self.assertGreaterEqual(report.bearish_external_to_internal_type_d_count, 0)
        ...
        self.assertGreaterEqual(report.bullish_internal_to_external_type_b_additive_extension_count, 0)
        self.assertGreaterEqual(report.bearish_internal_to_external_type_b_additive_extension_count, 0)
        self.assertGreaterEqual(
            report.bullish_internal_to_external_type_b_additive_extension_c3_quality_count,
            0,
        )
        self.assertGreaterEqual(
            report.bearish_internal_to_external_type_b_additive_extension_c3_quality_count,
            0,
        )
        ...
        self.assertGreaterEqual(report.bullish_internal_to_external_type_d_count, 0)
        self.assertGreaterEqual(report.bearish_internal_to_external_type_d_count, 0)
        ...
        self.assertGreaterEqual(report.bullish_type_b_additive_extension_count, 0)
        self.assertGreaterEqual(report.bearish_type_b_additive_extension_count, 0)
        self.assertGreaterEqual(
            report.bullish_type_b_additive_extension_c3_quality_count,
            0,
        )
        self.assertGreaterEqual(
            report.bearish_type_b_additive_extension_c3_quality_count,
            0,
        )
        ...
        self.assertGreaterEqual(report.bullish_type_b_additive_extension_c4_candidate_count, 0)
        self.assertGreaterEqual(report.bearish_type_b_additive_extension_c4_candidate_count, 0)
        self.assertGreaterEqual(
            report.bullish_type_b_additive_extension_c4_expansion_quality_count,
            0,
        )
        self.assertGreaterEqual(
            report.bearish_type_b_additive_extension_c4_expansion_quality_count,
            0,
        )
    ...
    def test_build_real_sample_report_tracks_internal_to_external_type_a_counts(self) -> None:
        candles = [
        ...
        self.assertEqual(report.bullish_internal_to_external_type_a_count, 1)
    ...
    def test_build_real_sample_report_tracks_internal_to_external_type_b_counts(self) -> None:
        candles = [
            ...
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 12), "4H", 106, 107, 103, 104),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 16), "4H", 104, 112, 103, 111),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 20), "4H", 111, 118, 108, 117),
            Candle("XAUUSD", utc_datetime(2026, 3, 15, 0), "4H", 108, 109, 101, 103),
            Candle("XAUUSD", utc_datetime(2026, 3, 15, 4), "4H", 103, 113, 100, 112),
        ]

        report = build_real_sample_report(candles)

        self.assertEqual(report.bullish_internal_to_external_type_b_count, 1)
        self.assertEqual(report.bearish_internal_to_external_type_b_count, 0)

    def test_build_real_sample_report_tracks_internal_to_external_type_c_counts(self) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 96, 100, 95, 99),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 4), "4H", 99, 105, 98, 104),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 8), "4H", 104, 110, 102, 109),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 12), "4H", 106, 107, 101, 103),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 16), "4H", 103, 110, 99, 108),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 20), "4H", 108, 115, 102, 114),
        ]
    ...
    def test_build_real_sample_report_tracks_internal_to_external_type_d_counts(self) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 96, 100, 95, 99),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 4), "4H", 99, 105, 98, 104),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 8), "4H", 104, 110, 102, 109),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 12), "4H", 106, 107, 101, 103),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 16), "4H", 103, 112, 99, 108),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 20), "4H", 108, 110, 100, 104),
        ]

        report = build_real_sample_report(candles)

        self.assertEqual(report.bullish_internal_to_external_type_c_count, 0)
        self.assertEqual(report.bearish_internal_to_external_type_c_count, 0)
        self.assertEqual(report.bullish_internal_to_external_type_d_count, 1)
        self.assertEqual(report.bearish_internal_to_external_type_d_count, 0)

    def test_build_real_sample_report_tracks_external_to_internal_type_c_counts(self) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 110, 112, 105, 108),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 4), "4H", 108, 109, 100, 101),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 8), "4H", 101, 115, 101, 114),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 12), "4H", 114, 118, 101, 105),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 16), "4H", 105, 106, 99, 100),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 20), "4H", 101, 120, 100.5, 119),
        ]

        report = build_real_sample_report(candles)

        self.assertEqual(report.bullish_external_to_internal_type_c_count, 1)
        self.assertEqual(report.bearish_external_to_internal_type_c_count, 0)
        self.assertEqual(report.bullish_external_to_internal_type_b_count, 0)
        self.assertEqual(report.bearish_external_to_internal_type_b_count, 0)

    def test_build_real_sample_report_tracks_external_to_internal_type_d_counts(self) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 110, 112, 105, 108),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 4), "4H", 108, 109, 100, 101),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 8), "4H", 101, 115, 101, 114),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 12), "4H", 114, 118, 101, 105),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 16), "4H", 105, 110, 99, 100.5),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 20), "4H", 101, 109, 100, 104),
        ]

        report = build_real_sample_report(candles)

        self.assertEqual(report.bullish_external_to_internal_type_c_count, 0)
        self.assertEqual(report.bearish_external_to_internal_type_c_count, 0)
        self.assertEqual(report.bullish_external_to_internal_type_d_count, 1)
        self.assertEqual(report.bearish_external_to_internal_type_d_count, 0)

    def test_build_real_sample_report_tracks_external_to_internal_type_b_additive_extension_counts(
        self,
    ) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 110, 112, 105, 108),
            ...
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 8), "4H", 101, 115, 101, 114),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 12), "4H", 106, 107, 101, 103),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 16), "4H", 100.5, 112, 99, 111),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 20), "4H", 111.5, 118, 110.5, 117),
        ]
    ...
    def test_build_real_sample_report_tracks_internal_to_external_type_b_additive_extension_counts(
        self,
    ) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 96, 100, 95, 99),
        ...
        self.assertEqual(report.bullish_internal_to_external_type_c_count, 0)
        self.assertEqual(report.bearish_internal_to_external_type_c_count, 0)
        self.assertEqual(report.bullish_internal_to_external_type_b_additive_extension_count, 1)
        self.assertEqual(report.bearish_internal_to_external_type_b_additive_extension_count, 0)

    def test_build_real_sample_report_tracks_external_to_internal_type_b_additive_extension_c3_quality_counts(
        self,
    ) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 110, 112, 105, 108),
    ...
    def test_build_real_sample_report_tracks_internal_to_external_type_b_additive_extension_c3_quality_counts(
        self,
    ) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 96, 100, 95, 99),
        ...
        self.assertEqual(report.bullish_internal_to_external_type_c_count, 0)
        self.assertEqual(
            report.bullish_internal_to_external_type_b_additive_extension_count,
            1,
        )
        self.assertEqual(
            report.bullish_internal_to_external_type_b_additive_extension_c3_quality_count,
    ...
    def test_count_type_b_additive_extensions_counts_bullish_and_bearish_windows(self) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 110, 112, 100, 102),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 4), "4H", 100, 116, 99.5, 114),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 8), "4H", 114, 120, 113, 118),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 12), "4H", 100, 110, 98, 108),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 16), "4H", 110, 110.5, 94, 96),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 20), "4H", 96, 97, 90, 92),
        ]

        bullish, bearish = count_type_b_additive_extensions(candles)
        self.assertEqual((bullish, bearish), (1, 1))

    def test_count_type_b_additive_extension_c3_quality_candidates_counts_bullish_and_bearish_windows(
        self,
    ) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 110, 112, 100, 102),
        ...
        bullish, bearish = count_type_b_additive_extension_c3_quality_candidates(candles)
        self.assertEqual((bullish, bearish), (1, 1))

    def test_count_type_b_additive_extension_c4_candidates_counts_bullish_and_bearish_windows(
        self,
    ) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 110, 112, 100, 102),
            ...
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 12), "4H", 118, 125, 117, 124),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 16), "4H", 100, 110, 98, 108),
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 20), "4H", 110, 110.5, 94, 96),
            Candle("XAUUSD", utc_datetime(2026, 3, 15, 0), "4H", 96, 101, 90, 92),
            Candle("XAUUSD", utc_datetime(2026, 3, 15, 4), "4H", 92, 94, 85, 86),
        ]

        bullish, bearish = count_type_b_additive_extension_c4_candidates(candles)
        self.assertEqual((bullish, bearish), (1, 1))

    def test_count_type_b_additive_extension_c4_expansion_quality_candidates_counts_bullish_and_bearish_windows(
        self,
    ) -> None:
        candles = [
            Candle("XAUUSD", utc_datetime(2026, 3, 14, 0), "4H", 110, 112, 100, 102),
        ...
        bullish, bearish = count_type_b_additive_extension_c4_expansion_quality_candidates(candles)
        self.assertEqual((bullish, bearish), (1, 1))
