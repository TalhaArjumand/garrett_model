...
def is_bullish_type_d(
    ...
    *,
    ...
    return (
        ...
        and not is_bullish_type_b_additive_extension(
            c1,
            c2,
            c3,
            max_lower_wick_fraction=max_lower_wick_fraction,
        )
        and not is_bullish_c3_closure(c1, c2, c3)
        and c3.high < c2.high
        and c3.low > c2.low
    )


def is_bearish_type_d(
    c1: Any,
    c2: Any,
    c3: Any,
    *,
    ...
    return (
        ...
        and not is_bearish_type_b_additive_extension(
            c1,
            c2,
            c3,
            max_upper_wick_fraction=max_upper_wick_fraction,
        )
        and not is_bearish_c3_closure(c1, c2, c3)
        and c3.high < c2.high
        and c3.low > c2.low
    )
...
def has_bullish_c4_after_type_d_candidate(
    c1: Any,
    c2: Any,
    c3: Any,
    c4: Any,
...
def has_bearish_c4_after_type_d_candidate(
    c1: Any,
    c2: Any,
    c3: Any,
    c4: Any,
